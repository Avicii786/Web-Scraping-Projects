...
target_url = "https://sellercentral.amazon.ae/fba/profitabilitycalculator/index"  # target url
...
outupt_data.to_excel("output.xlsx", index=False)

print("All the data stored in excel file name output.xlsx")
